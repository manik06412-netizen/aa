...
/* Premium Image Container Glow */
.product-image-wrapper:hover figure.goOnZoom {
    box-shadow: 0 10px 30px rgba(0, 112, 243, 0.15) !important;
    border-color: rgba(0, 112, 243, 0.3) !important;
}

/* Pulse Animation for Buy Now */
...
/* Image Zoom - Premium Magnifier Lens Style */
...
.zoom-result {
    ...
    background-color: #fff;
    z-index: 100;
    box-shadow: 0 16px 48px rgba(0, 0, 0, 0.14), 0 4px 16px rgba(0, 112, 243, 0.12);
    overflow: hidden;
}

/* On mobile, show zoom below */
                        ...
                        <div class="row  ">
                            <div class="col-lg-5 col-12 col-sm-12 " id="faq_cat">
                                <div class="row">
                                            ...
                                            <div class="mb-2 ">
                                                ...
                                                <div class="row pt-1">
                                                    <img src="<?php echo htmlspecialchars($src1); ?>"
                                                        ...
                                                        onclick="switchCarousel(0,this)" style="cursor:pointer;"
                                                ...
                                                <div class="row pt-1">
                                                    <img src="<?php echo htmlspecialchars($src2); ?>"
                                                        ...
                                                        onclick="switchCarousel(1,this)" style="cursor:pointer;"
                                                        onerror="this.onerror=null; this.src='<?php echo $noImagePlaceholder; ?>';">
                                                </div>
                                                <?php } ?>
                                                ...
                                                <div class="row pt-1">
                                                    <img src="<?php echo htmlspecialchars($src3); ?>"
                                                        ...
                                                        onclick="switchCarousel(2,this)" style="cursor:pointer;"
                                                        onerror="this.onerror=null; this.src='<?php echo $noImagePlaceholder; ?>';">
                                                </div>
                                                <?php } ?>
                                                ...
                                                <div class="row pt-1">
                                                    <img src="<?php echo htmlspecialchars($src4); ?>"
                                                        ...
                                                        onclick="switchCarousel(3,this)" style="cursor:pointer;"
                                                        onerror="this.onerror=null; this.src='<?php echo $noImagePlaceholder; ?>';">
                                                </div>
                                                <?php } ?>
                                                ...
                                                <div class="row pt-1">
                                                    <img src="<?php echo htmlspecialchars($src5); ?>"
                                                        ...
                                                        onclick="switchCarousel(4,this)" style="cursor:pointer;"
                                                        onerror="this.onerror=null; this.src='<?php echo $noImagePlaceholder; ?>';">
                                                </div>
                                                <?php } ?>
                                            </div>
                                    ...
                                    <!-- Zoom Result Panel - positioned absolutely relative to row -->
...
if (!empty($img5)) { ?>
                            ...
                            <div class="col-lg-5 col-12 " id="faq">
                                <div class="right_side_box">
                                    <h2 class="mt-2" style="font-family:'Outfit',sans-serif;font-weight:800;color:#0F172A; background: -webkit-linear-gradient(45deg, #0F172A, #0070F3); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo htmlspecialchars($title); ?></h2>
                                    <div class="row ">
                            ...
                            <div class="col-lg-10 col-12 col-sm-12 col-md-10 mt-3">
                                <div id="Description">
                                    ...
                                    <div class="col-12 mt-3 ">
                                        <div class="mb-5 mt-4">
                                            <h3 class="kc-detail-section-title" style="font-family:'Outfit',sans-serif; font-weight:700; font-size:1.25rem; color:#111827; text-transform:uppercase; letter-spacing:0.05em; border-bottom:1px solid #E5E7EB; padding-bottom:12px; margin-bottom:24px;">
                                                Product Description
                                            </h3>
                                            
                                            <div class="description-content" style="color:#374151; font-size:15px; line-height:1.8; text-align:justify; margin-bottom:30px;">
                                                <?= $description; ?>
                                            </div>
                                            
                                            <?php if(!empty(trim($stock))) { ?>
                                            <div class="stock-info mb-4" style="color:#111827; font-size:14px; font-weight:600; padding:10px 0; border-top:1px dashed #E5E7EB; border-bottom:1px dashed #E5E7EB;">
                                                <i class="fa fa-box-open mr-2" style="color:#6B7280;"></i> <?= $stock; ?>
                                            </div>
                                            <?php } ?>
                                            ...
                                            <div class="additional-features mt-4">
                                                <h4 style="font-family:'Outfit',sans-serif; font-size:1rem; font-weight:700; color:#111827; margin-bottom:16px;">Key Features & Specifications</h4>
                                                <div class="row">
                                                    <?php
                                                    while ($rowp = mysqli_fetch_array($res_prd)) {
                                                    ?>
                                                    <div class="col-12 col-md-6 mb-3">
                                                        <div class="feature-item" style="display:flex; align-items:flex-start; margin-bottom:8px;">
                                                            <div style="min-width:8px; height:8px; border-radius:50%; background-color:#9CA3AF; margin-top:8px; margin-right:12px;"></div>
                                                            <div>
                                                                <span style="display:block; font-family:'Outfit',sans-serif; font-weight:600; color:#111827; font-size:14.5px;">
                                                                    <?php echo $rowp['title']; ?>
                                                                </span>
                                                                <span style="color:#4B5563; font-size:14px; line-height:1.6; display:block;">
                                                                    <?php echo $rowp['desp']; ?>
                                                                </span>
                                                            </div>
                                                        </div>
...
<script>
// Premium Magnifier Lens Zoom
function initProductZoom() {
    const figures = document.querySelectorAll('figure.goOnZoom');
    const zoomResult = document.getElementById('zoomResult');
    if (!zoomResult) return;

    figures.forEach(function(figure) {
        // Create lens
        let lens = figure.querySelector('.zoom-lens');
        if (!lens) {
        ...
        function updateZoom(e) {
            ...
            let lensX = x - lensW / 2;
            let lensY = y - lensH / 2;
            lensX = Math.max(0, Math.min(lensX, figure.offsetWidth - lensW));
            lensY = Math.max(0, Math.min(lensY, figure.offsetHeight - lensH));
            ...
            const bgW = figure.offsetWidth  * zoomFactor;
            const bgH = figure.offsetHeight * zoomFactor;

            const bgX = -((lensX / figure.offsetWidth)  * bgW - resultW / 2);
            const bgY = -((lensY / figure.offsetHeight) * bgH - resultH / 2);
        ...
        figure.addEventListener('mousemove', updateZoom);
...
// Override old zoom function
function zoom(e) { /* deprecated - handled by initProductZoom */ }

function switchCarousel(index, element) {
    // Optionally update active state on thumbnails
    document.querySelectorAll('.slider_foots').forEach(el => {
        el.style.borderColor = '#dee2e6';
    });
    element.style.borderColor = '#0070F3';
}
