                ...
                <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0 pr-lg-4">
                    <a href="index.php" class="d-inline-block text-decoration-none">
                        <div class="kc-footer-brand-logo">
                            ...
                            <div class="uls-brand-text-wrap ml-2">
                                <span class="uls-brand-title-main text-white" style="font-size:18px;">KARUDA</span>
                                <span class="uls-brand-title-sub" style="color:#00BCD4; font-size:10px;">COMPUTERS</span>
                            </div>
                        </div>
                    </a>
