                                    ...
                                    <div class="card-body pt-3 pb-3 ml-2 mr-2 mt-2 mb-2">
                                        ...
                                        ?>
                                                <span class="discount_off text-white"><?=$discount_per; ?> %
                                                    off</span>
                                                <?php } ?>
                                                <div class="text-right d-flex justify-content-end align-items-center" style="gap:6px;">
                                                    <a href="details.php?id=<?=$cprid?>" class="btn btn-sm btn-outline-primary" style="font-size:11px;padding:4px 8px;font-weight:600;border-radius:6px;" title="View Product">
                                                        <i class="fa fa-eye"></i> View
                                                    </a>
                                                    <span class="w-100 h5" onclick="RemoveCard(<?=$cart_id?>)"
                                                        style="cursor:pointer;margin:0;"><i class="icon-trash border text-danger"
