                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class=""
                                                ...
                                                <input type="hidden" name="ratings" id="urating" value="0" required>
                                                <i class="fa fa-star star-icon" data-rating="1"
                                                    onclick="setRating(1)"></i>
                                                <i class="fa fa-star star-icon" data-rating="2"
                                                    onclick="setRating(2)"></i>
                                                <i class="fa fa-star star-icon" data-rating="3"
                                                    onclick="setRating(3)"></i>
                                                <i class="fa fa-star star-icon" data-rating="4"
                                                    onclick="setRating(4)"></i>
                                                <i class="fa fa-star star-icon" data-rating="5"
                                                    onclick="setRating(5)"></i>

                                            </div>
                                            <p class="text-bold " id="ratings_error" style="color:red; display:none;">
                                                Please select current star ratings!.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function setRating(ratings) {
    document.getElementById("urating").value = ratings;
...
async function Check_validation() {
    if (document.getElementById("urating").value == 0) {
        alert("Please select a current star rating!");
        return false;
    }
    if (document.getElementById("id_brcode").value == "") {
        alert("Please generate a barcode !");
        return false;
    }
...
document.getElementById("product_form").addEventListener("submit", async function(e) {
    ...
    document.getElementById("confirm-yes").onclick = function() {
        ...
        formData.append("product_submit", "");
        ...
        xhr.onload = function() {
            ...
            switch (result.status) {
                case 1:
                    ...
                    calloutDanger.style.display = "none";
                    calloutSuccess.innerHTML = "<p>Successfully registered!</p>";
                ...
                case 2:
                    ...
                    calloutDanger.innerHTML = "<p>Product name already exists!</p>";
                    break;
                case 3:
