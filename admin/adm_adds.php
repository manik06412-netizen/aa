...
if(isset($_POST['submit'] ))
{
	...
	$mql = "INSERT INTO adds(fpath) VALUES('" . $store . "')";
	mysqli_query($con, $mql);
			$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Congrats!</strong> New Image Added.</br></div>';
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Add Adds Image</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <table id="example23" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            function confirmDelete(categoryId) {
                                                ...
                                                if (confirmDelete) {
                                                    window.location.href = 'delete_adds.php?cat_del=' + categoryId;
                                                } else {
