...
if(isset($_POST['submit'] ))
{
	...
	if(mysqli_num_rows($check_cat) > 0)
     {
    	$error = '<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Coupon already exist!</strong>
															</div>';
     }
	else{
	...
	mysqli_query($con, $mql);
			$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Congrats!</strong> New Coupon Added Successfully.</br></div>';
                                            ...
                                            <div class="row p-t-20">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="dis" class="form-control" maxlength="8" min="1" placeholder="Enter Discount Amount" required>
