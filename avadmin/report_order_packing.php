    ...
    <?php endforeach; ?>
                                    ...
                                    <div class="box-body table-responsive">
                                        <table id="order2" class="table table-bordered table-hover table-striped">
                                            <thead>
                                                <tr>
                                                    <th style="width:10%">Packed Date</th>
                            ...
                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: left;">
    <b>
        <span class="text w-100 <?= $full_color; ?>"><?= $full_sts; ?></span>
    </b>
    <button 
        type="button" 
        class="btn btn-info btn-sm" 
        onclick="showShipmentDetails('<?= $order_id; ?>', '<?= $orders['final_amt']; ?>')">View</button>
</td>
...
function showShipmentDetails(orderId, finalAmt) {
    $.ajax({
        ...
        type: 'POST',
        data: { order_id: orderId, final_amt: finalAmt }, // Passing final amount along with order_id
