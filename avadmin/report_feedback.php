...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left;"><?=$orders['msg']; ?></td>
...
<script>
    document.getElementById('export_table').addEventListener('click', function() {
        ...
        let csvContent = 'Feedback Reports\n';
    ...
    document.getElementById('print_table').addEventListener('click', function() {
        ...
        printWindow.document.write('<h3 style="text-align:center;">Feedback Reports</h3>');
    ...
    document.getElementById('download_pdf').addEventListener('click', function() {
        ...
        html2canvas(document.querySelector("#order2"), {
            ...
            pdf.setFontSize(14);
            pdf.text('Feedback Reports', pdf.internal.pageSize.width / 2, 25, null, null, 'center');
