...
if (isset($_GET['desc_id']) && isset($_GET['prd_id'])) {
    ...
    try {
        ...
        header("Location: p_description.php?prd_id=$prd_id"); // Replace 'description_page.php' with your actual page
        exit;
    } catch (Exception $e) {
        ...
        header("Location: p_description.php?prd_id=$prd_id");
        exit;
    }
} else {
    // Redirect back if desc_id or prd_id is not set
    $_SESSION['error_message'] = 'Invalid request. Please try again.';
    header("Location: p_description.php"); // Replace with your actual description page
    exit;
}
