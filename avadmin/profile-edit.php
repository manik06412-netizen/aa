								...
								<div class="box-body">
									<div class="form-group">
										...
										if($_SESSION['user']['role'] == 'Super Admin') {
											?>
												<div class="col-sm-4">
													<input type="text" class="form-control" name="full_name" required value="<?php echo $full_name; ?>" required>
												</div>
											<?php
										} else {
											?>
									...
									<div class="form-group">
										...
										<input type="tel" class="form-control"
                                                            ...
                                                            pattern="^[7896][0-9]{9}$" required name="phone" />
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form1" required>Update Information</button>
										</div>
									</div>
								</div>
							</div>
