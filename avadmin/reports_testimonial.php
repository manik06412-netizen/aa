...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left;"><?=$orders['design']; ?></td>
                                                    <td style="text-align: left;"><?=$orders['message']; ?></td>
...
<script>
    document.getElementById('export_table').addEventListener('click', function() {
        ...
        let csvContent = 'Testimonial Reports\n';
    ...
    document.getElementById('download_pdf').addEventListener('click', function() {
        ...
        html2canvas(document.querySelector("#order2"), {
            ...
            pdf.setFontSize(14);
            pdf.text('Testimonial Reports', pdf.internal.pageSize.width / 2, 25, null, null, 'center');
