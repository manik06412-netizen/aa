...
<section class="content">
    ...
    foreach ($products as $d_id => $product) {
        ...
        echo '<tr>
            ...
            <div class="row">
            <div class="col-md-3">
               <img src="' . htmlspecialchars($product['img']) . '" class="img-responsive radius" style="height:50px;width:50px;" />
               </div>
                 <div class="col-md-6">
        ...
        foreach ($product['measurements'] as $measurement) {
            echo $measurement['quantity'] . $measurement['weight'] . " - <b>" . $measurement['stock'] . '</b><br />';
        }

        echo '</td>
            <td >
             <a href="#" data-toggle="modal" data-target="#editPriceModal" onclick="fet('. $d_id. ')"  class="btn btn-success btn-xs btn-flat btn-addon btn-sm m-b-10 m-l-5 edit-price" style="width:60%; margin-top:5px;" >Add stock</a><br/>

  <a href="#" data-toggle="modal" data-target="#reducepriceModal" onclick="red('. $d_id. ')" class="btn btn-warning btn-xs btn-flat btn-addon btn-sm m-b-10 m-l-5 edit-price" style="width:60%; margin-top:5px;">Reduce stock</a><br/>

  <a href="#" data-toggle="modal" data-target="#editPriceModal3" onclick="fetchStockData('. $d_id. ')" class="btn btn-info btn-xs btn-flat btn-addon btn-sm m-b-10 m-l-5 edit-price" style="width:60%; margin-top:5px;">Set stock</a>
          
               
                
            </td>
            <td style="text-align: left;"><h6>' . $statusText . '</h6></td>
            <td >
                <div class="row">

                    <div class="col-md-10">
                          <a href="#" data-toggle="modal" data-target="#stockupdateModal" onclick="stc('.$d_id.')" class="btn btn-danger btn-flat btn-addon btn-xs btn-sm m-b-10">Stop Selling</a>
                    </div>
                </div>
            </td>
        </tr>';
                    ...
                    formBody.innerHTML += `
                        <div class="row">
                         <div class="col-lg-9">
                            ...
                            <div class="col-lg-3">
                                <img src="${dish.img}" width="80px" style="margin-bottom:6px;" height="80px">
                            </div>
                        ...
                        <div class="col-lg-12">
                            <table class="table table-bordered">
                                ...
                                ${dish.qn.map((qn, index) => `
                                    <tr>
                                        <td>${qn} - ${dish.wg[index]}</td>
                                        <td>${dish.total[index]}</td>
                                        <td>
                                            <input type="text" name="new_stock" id="new_stock_${index}" pattern="\d*" oninput="validateNumber(this)" required>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-xs" onclick="submitRow(${index}, '${dish.pd_code[index]}', '${dish.price_id[index]}', '${dish.total[index]}', '${dish.stk_status[index]}')">Add</button>
                                        </td>
                                    </tr>
                                `).join('')}
                            </table>
                            ...
                            <table class="table table-bordered">
                                ...
                                ${dish.qn.map((qn, index) => `
                                    <tr>
                                        ...
                                        <td>${dish.total[index]}</td>
                                        <td>
                                            <input type="text" name="new_stock" pattern="\d*" oninput="validateNumber(this)" id="new_stock_${index}" required>
                                            <input type="hidden" name="prd_code" value="${dish.pd_code[index]}">
                                            <input type="hidden" name="price_id" value="${dish.price_id[index]}">
                                            <input type="hidden" name="prev_total" value="${dish.total[index]}">
                                            <input type="hidden" name="status" value="${dish.stk_status[index]}">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-xs" onclick="addStock(${index}, '${dish.pd_code[index]}', '${dish.price_id[index]}', '${dish.total[index]}', '${dish.stk_status[index]}')">Set</button>
                                        </td>
                                    </tr>
                                `).join('')}
                            </table>
    ...
    xhr.onload = function() {
        if (xhr.status >= 200 && xhr.status < 300) {
            ...
            if (response.error) {
                ...
                toastr.success('Stock fixed successfully', 'Success');
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ${dish.qn.map((qn, index) => `
                                        <tr>
                                            <td>${qn}</td>
                                            <td>${dish.wg[index]} - ${dish.total[index]}</td>
                                            <td><input type="text" name="reason" id="reason_${index}" required></td>
                                            <td>
                                                <input type="text" pattern="\d*" oninput="validateNumber(this)" name="new_stock" id="reduce_stock_${index}" required>
                                                <input type="hidden" name="prd_code" value="${dish.pd_code[index]}">
                                                <input type="hidden" name="price_id" value="${dish.price_id[index]}">
                                                <input type="hidden" name="prev_total" value="${dish.total[index]}">
                                                <input type="hidden" name="status" value="${dish.stk_status[index]}">
