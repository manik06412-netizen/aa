...
$title = isset($_SESSION['title']) ? $_SESSION['title'] : 'Faq Details';
...
<section class="content-header">
    ...
    <button class="btn btn-primary btn-xs" id="download_pdf">PDF</button>
		<a href="faq-add.php" class="btn  btn-md" style="background-color:#FF851B; color:white; border:1px solid #FF851B;">Add FAQ</a>
	</div>
</section>
