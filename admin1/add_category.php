...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['c_name'])) {
        ...
        if (mysqli_num_rows($check_cat) > 0) {
            ...
            if (!is_dir(__DIR__ . "/Res_img/dishes")) {
                @mkdir(__DIR__ . "/Res_img/dishes", 0777, true);
            }
            if (!is_dir(__DIR__ . "/../avadmin/Res_img/dishes")) {
                @mkdir(__DIR__ . "/../avadmin/Res_img/dishes", 0777, true);
            }
            if (!is_dir(__DIR__ . "/../admin/Res_img/dishes")) {
                @mkdir(__DIR__ . "/../admin/Res_img/dishes", 0777, true);
            }
            ...
            if (isset($_FILES['images']) && $_FILES['images']['error'] == 0) {
                ...
                if (in_array($extension, $allowed_extensions) && move_uploaded_file($temp, $store)) {
                    @copy($store, __DIR__ . '/../avadmin/' . $store);
                    @copy($store, __DIR__ . '/../admin/' . $store);
                    $store1 = $store;
                } else {
            ...
            if (isset($_FILES['images1']) && $_FILES['images1']['error'] == 0) {
                ...
                if (in_array($extension1, $allowed_extensions) && move_uploaded_file($temp1, $store1)) {
                    @copy($store1, __DIR__ . '/../avadmin/' . $store1);
                    @copy($store1, __DIR__ . '/../admin/' . $store1);
                } else {
