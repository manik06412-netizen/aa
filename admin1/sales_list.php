        ...
        <div class="col-md-12">
            ...
            <div class="av-stat-cards-row">
                ...
                <div class="av-stat-card" style="background:linear-gradient(135deg,#11998e 0%,#38ef7d 100%) !important;">
                    ...
                    <div class="av-stat-info">
                        <div class="av-stat-value">&#8377;<?= number_format($results[1] ?? 0, 2); ?></div>
                        <div class="av-stat-label">Received Amount</div>
                        <div class="av-stat-sub">Revenue collected today</div>
                    </div>
                </div>
                <div class="av-stat-card" style="background:linear-gradient(135deg,#f7971e 0%,#ffd200 100%) !important;">
                    ...
                    <div class="av-stat-info">
                        <div class="av-stat-value">&#8377;<?= number_format($results[2] ?? 0, 2); ?></div>
                        <div class="av-stat-label">Refund Amount</div>
                        <div class="av-stat-sub">Refunded today</div>
                    </div>
                </div>
                <div class="av-stat-card" style="background:linear-gradient(135deg,#21d4fd 0%,#b721ff 100%) !important;">
                    <div class="av-stat-icon"><i class="fa fa-check-circle"></i></div>
                    <div class="av-stat-info">
                        <div class="av-stat-value">&#8377;<?= number_format($results[3] ?? 0, 2); ?></div>
                        <div class="av-stat-label">Fulfilled Amount</div>
                        <div class="av-stat-sub">Delivered orders value</div>
                    </div>
                </div>
            </div>
            <!-- LAST 30 DAYS STAT CARDS -->
            <div class="av-stat-section-label"><i class="fa fa-calendar"></i>&nbsp; Last 30 Days Sales Summary</div>
            <div class="av-stat-cards-row" style="margin-bottom:20px;">
                ...
                <div class="av-stat-card" style="background:linear-gradient(135deg,#134e5e 0%,#71b280 100%) !important;">
                    <div class="av-stat-icon"><i class="fa fa-inr"></i></div>
                    <div class="av-stat-info">
                        <div class="av-stat-value">&#8377;<?= number_format($results_2[1] ?? 0, 2); ?></div>
                        <div class="av-stat-label">Received Amount</div>
                        <div class="av-stat-sub">Last 30 days revenue</div>
                    </div>
                </div>
                <div class="av-stat-card" style="background:linear-gradient(135deg,#c94b4b 0%,#4b134f 100%) !important;">
                    <div class="av-stat-icon"><i class="fa fa-undo"></i></div>
                    <div class="av-stat-info">
                        <div class="av-stat-value">&#8377;<?= number_format($results_2[2] ?? 0, 2); ?></div>
                        <div class="av-stat-label">Refund Amount</div>
                        <div class="av-stat-sub">Last 30 days</div>
                    </div>
                </div>
                <div class="av-stat-card" style="background:linear-gradient(135deg,#11998e 0%,#38ef7d 100%) !important;">
                    <div class="av-stat-icon"><i class="fa fa-check-circle"></i></div>
                    <div class="av-stat-info">
                        <div class="av-stat-value">&#8377;<?= number_format($results_2[3] ?? 0, 2); ?></div>
                        <div class="av-stat-label">Fulfilled Amount</div>
                        <div class="av-stat-sub">Last 30 days</div>
                    </div>
                </div>
