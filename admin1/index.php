...
<html lang="en" >
   <?php
      ...
      if(isset($_POST['submit']))
      {
      	...
      	if(!empty($_POST["submit"])) 
           {
            $loginquery = "SELECT * FROM admin WHERE BINARY username = '$username' AND password='" . $password . "'";
   ...
   <body>
      <style>
         .thumbnail {
         background-color: #fff; /* Replace with the actual color code if not using Bootstrap class */
         }
      </style>
      <div class="container">
         <div class="info">
      ...
      <div class="form">
         <div class="thumbnail" style="background-color: info;">
            <img src="images/manager.png" width="100%" alt="Manager Image">
         </div>
         <form class="register-form" action="index.php" method="post">
            <input type="text" placeholder="Enter a Username" name="cr_user"/>
            <input type="text" placeholder="email address"  name="cr_email"/>
            <input type="password" placeholder="Enter a Password"  name="cr_pass"/>
