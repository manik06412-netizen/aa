                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row p-t-20">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($about['id']); ?>">
                                                        <label class="control-label">About Us</label>
                                                        <textarea  class="form-control" rows="5" name="about_us" required><?php echo htmlspecialchars($about['about_us']); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-actions">
                                                <input type="submit" name="about" class="btn btn-success" value="Update">
