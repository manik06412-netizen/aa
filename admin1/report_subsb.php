...
$query = "SELECT * FROM tbl_subscriber order by subs_id desc";
...
?>
                                                ...
                                                <tr>
                                                    <td style="text-align: left;"><?=$orders['dat']; ?></td>
                                                    <td style="text-align: left;"><?=$orders['subs_email']; ?></td>
...
<script>
   document.getElementById('export_table').addEventListener('click', function() {
    ...
    let csvContent = 'Subscriber Reports\n';
...
document.getElementById('print_table').addEventListener('click', function() {
    ...
    printWindow.document.write('<h3 style="text-align:center;">Subscriber Reports</h3>');
...
pdf.text('Karuda Computers', pdf.internal.pageSize.width / 2, 20, null, null, 'center');
        ...
        pdf.setFontSize(14);
        pdf.text('Subscriber Reports', pdf.internal.pageSize.width / 2, 27, null, null, 'center');
